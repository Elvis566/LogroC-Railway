...
import { login,updateUsersPassword, updateUsersEmail, getUsers,createUsers,updateUsers,deleteUsers,getOneUser, getUsersT, getUsersAlphabetically} from '../controller/UserController.js';
import  {verifyToken}  from '../middleware/auth.js';
const rotuer = express.Router();
rotuer.get('/obtenerT', getUsersT);
rotuer.get('/obtenerAlf', getUsersAlphabetically);
